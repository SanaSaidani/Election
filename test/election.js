...
contract("Election", function(accounts){
    ...
    it("throws an exception for an invalid candidate", function() {
        return Election.deployed().then(function(instance) {
            ...
            assert.equal(voteCount, 1, "candidate 1 did not receive another vote");
            return electionInstance.candidates(2);
        }).then(function(candidate2) {
            var voteCount = candidate2[2];
            assert(voteCount, 0, "candidate 2 did not receive another vote");
        });
    });
    ...
    it("throws an exception for double voting", function() {
        ...
        // }).then(function(candidate2) {
        //     var voteCount = candidate2[2];
        //     assert.equal(voteCount, 1, "candidate 2 did not receive another vote");
        });
    });
